...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen md:h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex flex-col md:flex-row font-sans md:overflow-hidden">
            {/* Animated Background */}
            ...
            <div className="md:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white p-8 md:p-12 flex flex-col justify-between relative z-10">
                ...
                <div className="flex flex-col h-full justify-between">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 max-w-lg">
                            <div>
                                <h2 className="text-4xl md:text-5xl font-black leading-tight bg-gradient-to-r from-white via-blue-50 to-transparent bg-clip-text text-transparent drop-shadow-2xl">
                                    Welcome Back
                                </h2>
                                <div className="h-1 w-20 bg-gradient-to-r from-emerald-400 to-green-500 rounded-full mt-3 shadow-lg"></div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="group bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="h-10 w-10 bg-gradient-to-br from-emerald-400 to-green-500 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                    <Sparkles className="h-5 w-5 text-white" />
                                </div>
                                <h4 className="text-lg font-bold">AI Analytics</h4>
                            </div>
                            <p className="text-blue-100 text-sm leading-relaxed">Real-time recovery predictions with 95% accuracy</p>
                        </div>
                        <div className="group bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="h-10 w-10 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                    <Lock className="h-5 w-5 text-white" />
                                </div>
                                <h4 className="text-lg font-bold">Signzy Verification</h4>
                            </div>
                            <p className="text-blue-100 text-sm leading-relaxed">It supports KYC, document verification, and background checks</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="md:w-1/2 bg-white/80 backdrop-blur-xl p-6 md:p-12 flex items-center justify-center relative z-20">
