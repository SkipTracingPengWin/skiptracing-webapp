...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen lg:h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-100 flex flex-col lg:flex-row font-sans lg:overflow-hidden">
            ...
            <div className="lg:w-1/2 bg-gradient-to-br from-orange-500 via-amber-600 to-rose-600 text-white p-6 lg:p-12 flex flex-col justify-between relative z-10">
                ...
                <div className="flex flex-col h-full justify-between py-2">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center gap-2 bg-white/15 backdrop-blur-2xl p-2.5 rounded-xl border border-white/25 shadow-lg">
                            <div className="h-9 w-9 bg-gradient-to-br from-white/25 to-transparent rounded-xl flex items-center justify-center backdrop-blur-xl shadow-lg">
                                <Shield className="h-5 w-5 text-white drop-shadow-md" />
                            </div>
                            <div>
                                {/* CHANGE 5: Logo text-2xl→text-xl */}
                                <h1 className="text-lg font-black bg-gradient-to-r from-white via-amber-50 to-transparent bg-clip-text text-transparent">
                                    SkipTrace
                                </h1>
                                <p className="text-amber-100 text-[10px] font-semibold tracking-wide opacity-90">AI Debt Recovery</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2 max-w-sm">
                            <div>
                                ...
                                <div className="h-1 w-16 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full mt-1.5 shadow-md"></div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        <div className="group bg-white/15 backdrop-blur-2xl rounded-xl p-4 border border-white/25 hover:bg-white/25 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            <div className="flex items-center gap-2 mb-1.5">
                                <div className="h-8 w-8 bg-gradient-to-br from-amber-400 to-orange-500 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-105">
                                    <Star className="h-4 w-4 text-white" />
                                </div>
                                <h4 className="text-base font-bold text-white">14-Day Trial</h4>
                            </div>
                            <ul className="space-y-1 text-amber-100 text-[11px] font-medium">
            ...
            <div className="lg:w-1/2 bg-white/90 backdrop-blur-2xl p-4 lg:p-8 flex items-center justify-center relative z-20 border border-white/50 shadow-xl">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-5">
                        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 via-amber-600 to-rose-500 text-white px-3 py-1.5 rounded-xl shadow-lg mb-3 backdrop-blur-xl border border-white/30">
                            <Sparkles className="h-3.5 w-3.5 animate-spin" />
                            <span className="text-base font-black tracking-wide">Create Account</span>
                        </div>
                        <p className="text-slate-700 text-xs font-semibold">Join recovery professionals</p>
                    </div>

                    {error && (
                        <div className="bg-gradient-to-r from-rose-500/10 to-orange-500/10 text-rose-800 p-2.5 rounded-xl border border-rose-200/50 backdrop-blur-xl mb-3 shadow-md">
                    ...
                    <form className="space-y-3" onSubmit={handleRegister}>
                        <div className="group">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 bg-white/90 backdrop-blur-xl border-2 border-slate-200/70 rounded-xl focus:ring-3 focus:ring-amber-500/20 focus:border-amber-500 shadow-md transition-all duration-200 group-hover:border-amber-300 text-sm placeholder:text-slate-400"
                                    required
                                />
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-amber-600">
                                    <User className="h-4 w-4 text-slate-400 group-focus-within:text-amber-600" />
                                </div>
                            </div>
                        </div>

                        <div className="group">
                            <label className="block text-xs font-bold text-slate-900 mb-1">Work Email</label>
                            <div className="relative">
                                <input
                                    id="email"
                                    type="email"
                                ...
                                />
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-amber-600">
                                    <Mail className="h-4 w-4 text-slate-400 group-focus-within:text-amber-600" />
                                </div>
                            </div>
                        </div>

                        <div className="group">
                            <label className="block text-xs font-bold text-slate-900 mb-1">Company</label>
                            <div className="relative">
                                <input
                                    id="company"
                                    type="text"
                                ...
                                />
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-amber-600">
                                    <Building2 className="h-4 w-4 text-slate-400 group-focus-within:text-amber-600" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    value={formData.role}
                                    onChange={handleChange}
                                    className="w-full pl-10 pr-10 py-2.5 bg-white/90 backdrop-blur-xl border-2 border-slate-200/70 rounded-xl focus:ring-3 focus:ring-amber-500/20 focus:border-amber-500 shadow-md transition-all duration-200 group-hover:border-amber-300 text-sm font-medium text-slate-700 appearance-none cursor-pointer"
                                    required
                                >
                                ...
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-amber-600">
                                    <Briefcase className="h-4 w-4 text-slate-400 group-focus-within:text-amber-600" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full pl-10 pr-12 py-2.5 bg-white/90 backdrop-blur-xl border-2 border-slate-200/70 rounded-xl focus:ring-3 focus:ring-amber-500/20 focus:border-amber-500 shadow-md transition-all duration-200 group-hover:border-amber-300 text-sm placeholder:text-slate-400"
                                    required
                                />
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-amber-600">
                                    <Lock className="h-4 w-4 text-slate-400 group-focus-within:text-amber-600" />
                                </div>
                                <button
                                    type="button"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="group w-full bg-gradient-to-r from-orange-500 via-amber-600 to-rose-600 hover:from-orange-600 hover:via-amber-700 hover:to-rose-700 text-white font-bold py-2.5 rounded-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-0.5 disabled:opacity-60 flex items-center justify-center gap-1.5 text-sm border border-white/30"
                        >
