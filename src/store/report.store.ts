...
//   id: string;
//   name: string;
//   icon: 'TrendingUp' | 'FileText' | 'Users' | 'BarChart2'; // limited icon names we use
//   desc: string;
// };
...
// // Provide an alternative export name for backwards compatibility
// export const useReportStore = useDashboardStore;
