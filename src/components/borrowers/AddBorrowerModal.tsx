...
export default function AddBorrowerModal({ isOpen, onClose }: AddBorrowerModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newBorrower: Partial<Borrower> = {
            ...
            console.log("PAYLOAD DEBUG:", newBorrower);
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden max-h-[90vh] overflow-y-auto border border-slate-100/20 animate-in slide-in-from-bottom-4 duration-300">
                ...
                <div className="relative flex items-center justify-between px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 border-b border-blue-500/20">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-white">Add New Borrower</h2>
                            <p className="text-xs text-blue-100">Complete the form to register a new borrower</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
